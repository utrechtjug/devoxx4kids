...
[horizontal]
Ctrl + s:: in de editor, om de wijzigingen op te slaan + In de editor heeft de tab een bolletje als het document is gewijzigd maar niet gesaved, maar een kruisje als het bestand wel is gesaved.
...
Voeg onderaan het document de volgende functie toe:
