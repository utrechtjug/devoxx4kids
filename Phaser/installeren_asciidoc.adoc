...
Om tekstfiles die een AsciiDoc formaat hebben in .html of .pdf files om te zetten is de software AsciiDoctor nodig. Deze kan het gemakkelijkst worden als een Ruby gem, maar daarvoor moet je wel eerst Ruby geinstalleerd hebben.
